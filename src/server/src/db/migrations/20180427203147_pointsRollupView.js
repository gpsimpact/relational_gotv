        ...
        CREATE VIEW points_rollup AS (
          WITH sums_table AS (
            ...
            SELECT
              ...
              SUM(vo_voted_primary) AS vo_voted_primary_count,
          ...
          + (vo_voted_primary_count * 15) -- 15 points for each voter who voted in primary
          + (vo_voted_general_count * 10) -- 10 points for each voter who voted in general
          AS earned,
